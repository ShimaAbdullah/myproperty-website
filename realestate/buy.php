...
<head>
<title>Buy - Real Estate Management System</title>
<meta charset="UTF-8" />
...
<div class="inside-banner">
  <div class="container">
    <h2>Listing All Properties on Buy</h2>
</div>
</div>
 		...
 		<option value="Buy">Buy</option>
            ...
            <div class="col-lg-7">
              <select name="search_price" class="form-control">
                <option>Price</option>
                <option value="1">RM5000 - RM50,000</option>
                <option value="2">RM50,000 - RM100,000</option>
                <option value="3">RM100,000 - RM200,000</option>
