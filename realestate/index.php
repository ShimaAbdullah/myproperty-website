              ...
              <ul class="pull-right">
                ...
                <li><a href="list-properties.php">List Properties</a>
                	 <ul class="dropdown">
						...
						<li><a href="buy.php">Properties on Buy</a></li>
                    </ul>
                </li>
        ...
        <div class="sl-slider">
          ...
          <div class="sl-slide" data-orientation="horizontal" data-slice1-rotation="-25" data-slice2-rotation="-25" data-slice1-scale="2" data-slice2-scale="2">
            <div class="sl-slide-inner">
              ...
              <h2><a href="#">For Sale ‼️Eco Botanic 3-Storey Shop(End Lot)</a></h2>
              <blockquote>
              <p class="location"><span class="glyphicon glyphicon-map-marker"></span> Eco Botanic 3</p>
              <p>Asking Selling Price : RM2,750,000!</p>
			  <cite>RM 2,750,000.00</cite>
				<ul>
				<li>Eco Botanic 3-Storey Shop (End Lot)</li>
				<li>Type : 3 Storey Shoplot</li>
				<li>Floor Area : 24 x 70</li>
				<li>Built up ： 5217 sqft</li>
				<li>Furnish : Uufurnishing</li>
				<li>Status : Non-bumi</li>
				<li>Tenure: Freehold</li>
				<li>Existing Rental Income : RM8,500</li>
				</ul>
              </blockquote>
            </div>
          </div>
          ...
          <div class="sl-slide" data-orientation="vertical" data-slice1-rotation="10" data-slice2-rotation="-15" data-slice1-scale="1.5" data-slice2-scale="1.5">
            <div class="sl-slide-inner">
              ...
              <h2><a href="#">Johor’s Newest Panaromic Address in Molek</a></h2>
              <blockquote>
              <p class="location"><span class="glyphicon glyphicon-map-marker"></span> Taman Molek </p>
              <p> Stylish Lifestyle Made Simple.Pangsapuri Saujana Indah, Molek – brings you an exclusive living experience.</p>
              <cite>RM 300,900.00</cite>
			  <ul>
				<li>Major Highways</li>
				<li>15KM To Custom & Immigration</li>
				<li>Easily Accessible</li>
				<li>Close To Daiman 18 Golf Club</li>
				<li>Nature Recreation</li>
				<li>Conveniently Close To CIQ JB CENTRAL</li>
				</ul>		  
              </blockquote>
            </div>
          </div>
          ...
          <div class="sl-slide" data-orientation="horizontal" data-slice1-rotation="3" data-slice2-rotation="3" data-slice1-scale="2" data-slice2-scale="1">
            <div class="sl-slide-inner">
              ...
              <h2><a href="#">Aparment on Sale 2 Bed Rooms and 1 Dinning Room </a></h2>
              <blockquote>
              <p class="location"><span class="glyphicon glyphicon-map-marker"></span> Taman Saujana Apartment</p>
              <p>Until he extends the circle of his compassion to all living things, man will not himself find peace.</p>
              <cite> RM 300,000.00</cite>
              </blockquote>
            </div>
          </div>
          ...
          <div class="sl-slide" data-orientation="vertical" data-slice1-rotation="-5" data-slice2-rotation="25" data-slice1-scale="2" data-slice2-scale="1">
            <div class="sl-slide-inner">
              ...
              <h2><a href="#">Aparment on Sale 2 Bed Rooms and 1 Dinning Room </a></h2>
              <blockquote>
              <p class="location"><span class="glyphicon glyphicon-map-marker"></span> Taman Molek Apartment</p>
              <p>Until he extends the circle of his compassion to all living things, man will not himself find peace.</p>
              <cite>RM 270,000.00</cite>
              </blockquote>
            </div>
          </div>
          ...
          <div class="sl-slide" data-orientation="horizontal" data-slice1-rotation="-5" data-slice2-rotation="10" data-slice1-scale="2" data-slice2-scale="1">
            <div class="sl-slide-inner">
              ...
              <h2><a href="#">Aparment on Sale 2 Bed Rooms and 1 Dinning Room </a></h2>
              <blockquote>
              <p class="location"><span class="glyphicon glyphicon-map-marker"></span> Taman Molek Brand New Apartment</p>
              <p>Until he extends the circle of his compassion to all living things, man will not himself find peace.</p>
              <cite>RM 270,000.00</cite>
              </blockquote>
            </div>
          ...
          <div class="row">
            ...
            <div class="col-lg-3 col-sm-4">
             <select name="search_price" class="form-control">
                <option>Price</option>
                <option value="1">RM5000 - RM 50,000</option>
                <option value="2">RM50,000 - RM 100,000</option>
                <option value="3">RM100,000 - RM 200,000</option>
                <option value="4">RM200,000 - above</option>
              </select>
            </div>
            <div class="col-lg-3 col-sm-4">
  ...
  <div class="spacer">
    <div class="row">
      <div class="col-lg-12 col-sm-12 recent-view">
        <h3>About Us</h3>
			<p>First Global Properties Sdn Bhd – is a property investment agency established in 2016, specializing in purchase, sale and marketing of residential and commercial properties - offering state-of-the-art solutions for buyers, sellers, investors and developers.<br><a href="about.html">Learn More</a></p>
      </div>
...
<div class="row">
            ...
            <div class="col-lg-3 col-sm-3">
             ...
             <div class="col-lg-3 col-sm-3">
                    <h4>Contact us</h4>
                    <p><b>First Global Real Estate</b><br>
<span class="glyphicon glyphicon-map-marker"></span>27-1 & 27-2, Jln Mutiara Emas 10/19, Taman Mount Austin, 81100 Johor Bahru, Johor.<br>
<span class="glyphicon glyphicon-envelope"></span>shimabintiabdullah@gmail.com<br>
<span class="glyphicon glyphicon-earphone"></span> +6014 214 3000</p>
            </div>
        </div>
<p class="copyright">Copyright 2023.Shima Abdullah All rights reserved.</p>
