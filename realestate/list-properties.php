    ...
    <div class="row">
            ...
            <div class="col-lg-7">
              <select name="search_price" class="form-control">
                <option>Price</option>
                <option value="1">RM 5000 - RM 50,000</option>
                <option value="2">RM 50,000 - RM 100,000</option>
                <option value="3">RM 100,000 - RM 200,000</option>
                <option value="4">RM 200,000 - above</option>
              </select>
            </div>
          </div>
